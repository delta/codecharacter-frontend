...
import { m as n } from './Dashboard-988cf677.js';
...
((l = g || (g = {})).MIN_VALUE = -2147483648),
  ...
  ((X = z || (z = {})).replace = function (e, t) {
    return { range: e, newText: t };
  }),
  (X.insert = function (e, t) {
  ...
  (Q.is = function (e) {
    var t = e;
    return z.is(t) && (B.is(t.annotationId) || $.is(t.annotationId));
  }),
  ((J = Y || (Y = {})).create = function (e, t) {
    ...
    return (
      ...
      (void 0 === t.documentChanges ||
        t.documentChanges.every(function (e) {
          return at.string(e.kind) ? Z.is(e) || te.is(e) || re.is(e) : Y.is(e);
        }))
    );
  });
var se,
