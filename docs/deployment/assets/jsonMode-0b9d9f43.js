...
((l = g || (g = {})).MIN_VALUE = -2147483648),
  ...
  (V.is = function (e) {
    ...
    return (
      ...
      (at.undefined(n.relatedInformation) ||
        at.typedArray(n.relatedInformation, P.is))
    );
  }),
  ...
  (Q.is = function (e) {
    var t = e;
    return H.is(t) && (X.is(t.annotationId) || $.is(t.annotationId));
  }),
  ...
  Tt = class {
    ...
    provideDocumentFormattingEdits(e, t, n) {
      ...
      return this._worker(r).then(e =>
        e.format(r.toString(), null, Dt(t)).then(e => {
  ...
  Rt = class {
    ...
    provideDocumentRangeFormattingEdits(e, t, n, r) {
      ...
      return this._worker(i).then(e =>
        e.format(i.toString(), ft(t), Dt(n)).then(e => {
          if (e && 0 !== e.length) return e.map(vt);
        }),
      );
    }
    ...
    equals(e) {
      return (
        ...
        (!!(e && e instanceof en) &&
          ...
          Zt.equals(this.parents, e.parents))
      );
    }
    getStateData() {
      return this._state;
...
function nn(e) {
  ...
  function o() {
    ...
    on(n),
      ...
      r.colors && n.push(d.languages.registerColorProvider(t, new Pt(i))),
      r.foldingRanges &&
