...
((l = g || (g = {})).MIN_VALUE = -2147483648),
  ...
  ((R = j || (j = {})).Comment = 'comment'),
  (R.Imports = 'imports'),
  (R.Region = 'region'),
  ((T = P || (P = {})).create = function (e, t, n, r, i) {
...
!(function () {
  ...
  ((Re = je || (je = {})).fromPlainText = function (e) {
  ...
  Rt = class {
    ...
    provideDocumentFormattingEdits(e, t, n) {
      ...
      return this._worker(r).then(e =>
        e.format(r.toString(), null, Tt(t)).then(e => {
  ...
  Pt = class {
    ...
    provideDocumentRangeFormattingEdits(e, t, n, r) {
      ...
      return this._worker(i).then(e =>
        e.format(i.toString(), ft(t), Tt(n)).then(e => {
          if (e && 0 !== e.length) return e.map(vt);
        }),
      );
    }
...
function Ot(e) {
  ...
  d.languages.registerCompletionItemProvider(r, new Ft(n)),
    ...
    d.languages.registerLinkProvider(r, new jt(n)),
    ...
    'html' === r &&
      (d.languages.registerDocumentFormattingEditProvider(r, new Rt(n)),
  ...
  return (
    (function () {
      ...
      Ut(n),
        ...
        r.links && n.push(d.languages.registerLinkProvider(t, new jt(i))),
        r.documentSymbols &&
        ...
        r.documentFormattingEdits &&
          n.push(
            d.languages.registerDocumentFormattingEditProvider(t, new Rt(i)),
          ),
