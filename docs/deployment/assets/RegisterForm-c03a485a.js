...
import { F as f, g as m, h } from './index.es-8a521e47.js';
import { s as y } from './auth.module-7fd06f12.js';
import { R as v } from './index.esm-560e8225.js';
import { O as g } from './OtherDetails-b96a3675.js';
import { F as C } from './Form-0bcab3dd.js';
...
var A = 'function' == typeof Symbol && Symbol.for,
  ...
  z = A ? Symbol.for('react.forward_ref') : 60112,
...
function ae() {
  ...
  const U = c(s);
  e.useEffect(() => {
    if ('Username/Email already exists' === U) b(1), j(''), N('');
  }, [U]),
    e.useEffect(() => {
      z && (b(1), G('/login', { replace: !0 }), G(0));
    }, [z]);
  const B = e => {
