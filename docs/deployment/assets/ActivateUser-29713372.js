...
import { u as n, c as o } from './ThemeProvider-528d6954.js';
import { c as l } from './createWithBsPrefix-3a2cf2e8.js';
import { d as m } from './divWithClassName-662bab3a.js';
    ...
    return (
      ...
      a('div', {
        ...
        children: a(j, {
          ...
          children: c(j.Body, {
            children: [
              a(j.Title, { className: 'Verified' === f ? V : S, children: f }),
              a('div', {
