import { c as e, u as a } from './ThemeProvider-a8cd1696.js';
import { p as s } from './index-06bcf729.js';
import { r as l, c as t, j as r, F as o } from './index-624895d1.js';
import { a as i, F as n } from './FormGroup-c1cd9298.js';
import { c } from './createWithBsPrefix-b4c3ccd3.js';
import { C as d } from './Col-465cf901.js';
const m = { type: s.string, tooltip: s.bool, as: s.elementType },
  f = l.forwardRef(
    (
      { as: a = 'div', className: s, type: l = 'valid', tooltip: r = !1, ...o },
      i,
    ) =>
      t(a, {
        ...o,
        ref: i,
        className: e(s, `${l}-${r ? 'tooltip' : 'feedback'}`),
      }),
  );
...
const p = f,
  b = l.forwardRef(
    (
      ...
      return (
        (r = a(r, 'form-check-input')),
        t(m, {
          ...f,
          ref: p,
          type: n,
          id: s || b,
          className: e(o, r, c && 'is-valid', d && 'is-invalid'),
        })
      );
    },
  );
...
const u = b,
  y = l.forwardRef(({ bsPrefix: s, className: r, htmlFor: o, ...n }, c) => {
    const { controlId: d } = l.useContext(i);
    return (
      (s = a(s, 'form-check-label')),
      t('label', { ...n, ref: c, htmlFor: o || d, className: e(r, s) })
    );
  });
        ...
        children: t('div', {
          ...
          children:
            ...
            r(o, {
              children: [
                z,
                L && t(h, { title: I, children: C }),
                x && t(p, { type: v, tooltip: N, children: x }),
              ],
            }),
        }),
      });
...
const F = Object.assign(v, { Feedback: p }),
  ...
  I = l.forwardRef(
    (
      ...
      const y = e(c, r, n && 'visually-hidden', o && u);
      return (
        (m = m || b),
        o
          ? t(d, { ref: p, as: 'label', className: y, htmlFor: m, ...f })
          : t(s, { ref: p, className: y, htmlFor: m, ...f })
      );
    },
  );
...
const k = I,
  C = l.forwardRef(({ bsPrefix: s, className: r, id: o, ...n }, c) => {
    const { controlId: d } = l.useContext(i);
    return (
      (s = a(s, 'form-range')),
      t('input', {
...
const R = P,
  $ = l.forwardRef(
    ({ bsPrefix: s, className: l, as: r = 'small', muted: o, ...i }, n) => (
      (s = a(s, 'form-text')),
      t(r, { ...i, ref: n, className: e(l, s, o && 'text-muted') })
    ),
  );
$.displayName = 'FormText';
const j = $,
  T = l.forwardRef((e, a) => t(x, { ...e, ref: a, type: 'switch' }));
  ...
  z = l.forwardRef(
    (
      ...
      r(n, {
        ...
        controlId: i,
        ...d,
        children: [o, t('label', { htmlFor: i, children: c })],
      })
    ),
  );
...
const S = z,
  ...
  V = l.forwardRef(({ className: a, validated: s, as: l = 'form', ...r }, o) =>
    t(l, { ...r, ref: o, className: e(a, s && 'was-validated') }),
  );
