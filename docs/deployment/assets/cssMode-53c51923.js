...
((l = g || (g = {})).MIN_VALUE = -2147483648),
  ...
  ((R = T || (T = {})).Comment = 'comment'),
  (R.Imports = 'imports'),
  (R.Region = 'region'),
  ((P = j || (j = {})).create = function (e, t, n, r, i) {
...
!(function () {
  ...
  ((Re = Te || (Te = {})).fromPlainText = function (e) {
  ...
  ((je || (je = {})).is = function (e) {
    ...
    return (
      ...
      (ve.is(t.contents) ||
        Te.is(t.contents) ||
        at.typedArray(t.contents, Te.is)) &&
  ...
  return (
    (function () {
      ...
      Nt(n),
        ...
        r.references &&
          n.push(d.languages.registerReferenceProvider(t, new Ct(i))),
        r.documentSymbols &&
...
export {
  ...
  Tt as DocumentLinkAdapter,
  jt as DocumentRangeFormattingEditProvider,
