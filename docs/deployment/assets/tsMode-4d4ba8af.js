...
import { t as i, m as s } from './Dashboard-988cf677.js';
    ...
    async provideDocumentSymbols(e, t) {
      ...
      const n = (t, i, s) => {
        let r = {
          name: i.text,
          detail: '',
          kind: P[i.kind] || g.languages.SymbolKind.Variable,
...
u(I, 'unknown', ''),
  ...
  u(I, 'module', 'module'),
  u(I, 'class', 'class'),
  u(I, 'interface', 'interface'),
  u(I, 'type', 'type'),
  u(I, 'enum', 'enum'),
  u(I, 'variable', 'var'),
  u(I, 'localVariable', 'local var'),
  u(I, 'function', 'function'),
  u(I, 'localFunction', 'local function'),
  u(I, 'memberFunction', 'method'),
  u(I, 'memberGetAccessor', 'getter'),
  u(I, 'memberSetAccessor', 'setter'),
  u(I, 'memberVariable', 'property'),
  u(I, 'constructorImplementation', 'constructor'),
  u(I, 'callSignature', 'call'),
  u(I, 'indexSignature', 'index'),
  u(I, 'constructSignature', 'construct'),
  u(I, 'parameter', 'parameter'),
  u(I, 'typeParameter', 'type parameter'),
  u(I, 'primitiveType', 'primitive type'),
  u(I, 'label', 'label'),
  u(I, 'alias', 'alias'),
  u(I, 'const', 'const'),
  u(I, 'let', 'let'),
...
(P[I.module] = g.languages.SymbolKind.Module),
  (P[I.class] = g.languages.SymbolKind.Class),
  (P[I.enum] = g.languages.SymbolKind.Enum),
  (P[I.interface] = g.languages.SymbolKind.Interface),
  (P[I.memberFunction] = g.languages.SymbolKind.Method),
  (P[I.memberVariable] = g.languages.SymbolKind.Property),
  (P[I.memberGetAccessor] = g.languages.SymbolKind.Property),
  (P[I.memberSetAccessor] = g.languages.SymbolKind.Property),
  (P[I.variable] = g.languages.SymbolKind.Variable),
  (P[I.const] = g.languages.SymbolKind.Variable),
  (P[I.localVariable] = g.languages.SymbolKind.Variable),
  (P[I.variable] = g.languages.SymbolKind.Variable),
  (P[I.function] = g.languages.SymbolKind.Function),
  (P[I.localFunction] = g.languages.SymbolKind.Function);
var L,
  A,
  T = class extends f {
