import { c as e, u as t, e as n } from './ThemeProvider-a8cd1696.js';
import {
  a9 as o,
  aS as r,
  r as s,
...
import { c as d } from './createWithBsPrefix-b4c3ccd3.js';
import { p as f } from './index-06bcf729.js';
import { d as p } from './divWithClassName-487073c7.js';
function m(e) {
...
const Ce = s.forwardRef((e, t) => {
  ...
  const Z = U(() => {
    ...
    J = U(e => {
      e.target === e.currentTarget && (null == m || m(e), !0 === f && T());
    }),
    Q = U(e => {
      p &&
        27 === e.keyCode &&
        H.isTopModal() &&
        (null == h || h(e), e.defaultPrevented || T());
    }),
    ee = s.useRef(),
    te = s.useRef();
  if (!W) return null;
  ...
  (
    ...
    return i(De.Provider, {
      ...
      children: i(we, {
        ...
        onEntered: S,
        onExit: e => {
          null == Z.current || Z.current(), null == T || T(e);
        },
        onExiting: D,
        onExited: e => {
          e && (e.style.display = ''),
