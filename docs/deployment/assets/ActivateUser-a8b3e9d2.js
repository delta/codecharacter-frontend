...
import { u as n, c as o } from './ThemeProvider-a8cd1696.js';
import { c as l } from './createWithBsPrefix-b4c3ccd3.js';
import { d as m } from './divWithClassName-487073c7.js';
...
const x = u,
  p = e.forwardRef(({ bsPrefix: r, className: t, as: i = 'div', ...s }, d) => {
...
const j = Object.assign(T, {
  ...
  z = '_modalContainer_xkz8h_1',
  B = '_cardContainer_xkz8h_10',
  V = '_cardTitle_xkz8h_15',
  H = '_cardBody_xkz8h_16',
  R = '_cardTitleFailed_xkz8h_22',
  S = '_cardBodyFailed_xkz8h_23',
  $ = () => {
    const n = r(),
      o = t(),
    ...
    return (
      ...
      a('div', {
        ...
        children: a(j, {
          ...
          children: c(j.Body, {
            children: [
              a(j.Title, { className: 'Verified' === f ? V : R, children: f }),
              a('div', {
                className: 'Verified' === f ? H : S,
                children: a(j.Text, { children: u }),
              }),
            ],
          }),
        }),
