...
import { m as n } from './Dashboard-d64d825e.js';
...
((l = g || (g = {})).MIN_VALUE = -2147483648),
  ...
  ((T = R || (R = {})).Comment = 'comment'),
  (T.Imports = 'imports'),
  (T.Region = 'region'),
  ((j = P || (P = {})).create = function (e, t, n, r, i) {
  ...
  ((V = W || (W = {})).create = function (e, t, n, r, i, o) {
  ...
  (Q.is = function (e) {
    var t = e;
    return z.is(t) && (X.is(t.annotationId) || $.is(t.annotationId));
  }),
  ((Y = J || (J = {})).create = function (e, t) {
    ...
    return (
      ...
      (void 0 === t.documentChanges ||
        t.documentChanges.every(function (e) {
          return at.string(e.kind) ? Z.is(e) || te.is(e) || re.is(e) : J.is(e);
        }))
    );
  });
var se,
...
!(function () {
  ...
  (ke.Snippet = 2),
  ((ye || (ye = {})).Deprecated = 1),
  ((xe = Ee || (Ee = {})).create = function (e, t, n) {
  ...
  ((Te = Re || (Re = {})).fromPlainText = function (e) {
  ...
  ((Pe || (Pe = {})).is = function (e) {
    ...
    return (
      ...
      (ve.is(t.contents) ||
        Re.is(t.contents) ||
        at.typedArray(t.contents, Re.is)) &&
      (void 0 === e.range || v.is(e.range))
    );
  }),
  ((je || (je = {})).create = function (e, t) {
  ...
  (Xe.is = function (e) {
    ...
    return (
      at.defined(t) &&
      at.typedArray(t.diagnostics, W.is) &&
      (void 0 === t.only || at.typedArray(t.only, at.string))
    );
  }),
  (($e = qe || (qe = {})).create = function (e, t, n) {
    var r = { title: e },
      i = !0;
    return (
      'string' == typeof t
  ...
  ($e.is = function (e) {
    ...
    return (
      t &&
      at.string(t.title) &&
      (void 0 === t.diagnostics || at.typedArray(t.diagnostics, W.is)) &&
  ...
  Tt = class {
    ...
    provideDocumentFormattingEdits(e, t, n) {
      ...
      return this._worker(r).then(e =>
        e.format(r.toString(), null, jt(t)).then(e => {
  ...
  Pt = class {
    ...
    provideDocumentRangeFormattingEdits(e, t, n, r) {
      ...
      return this._worker(i).then(e =>
        e.format(i.toString(), ft(t), jt(n)).then(e => {
          if (e && 0 !== e.length) return e.map(vt);
        }),
      );
    }
...
function Ot(e) {
  ...
  let r = e.languageId;
  d.languages.registerCompletionItemProvider(r, new Ft(n)),
    d.languages.registerHoverProvider(r, new _t(n)),
    d.languages.registerDocumentHighlightProvider(r, new kt(n)),
    d.languages.registerLinkProvider(r, new Rt(n)),
    d.languages.registerFoldingRangeProvider(r, new Mt(n)),
    d.languages.registerDocumentSymbolProvider(r, new At(n)),
    d.languages.registerSelectionRangeProvider(r, new Lt(n)),
    d.languages.registerRenameProvider(r, new It(n)),
    'html' === r &&
      (d.languages.registerDocumentFormattingEditProvider(r, new Tt(n)),
      d.languages.registerDocumentRangeFormattingEditProvider(r, new Pt(n)));
}
function Nt(e) {
  const t = [],
    n = [],
  ...
  return (
    (function () {
      ...
      Wt(n),
        r.completionItems &&
          n.push(d.languages.registerCompletionItemProvider(t, new Ft(i))),
        ...
        r.links && n.push(d.languages.registerLinkProvider(t, new Rt(i))),
        r.documentSymbols &&
...
export {
  ...
  Pt as DocumentRangeFormattingEditProvider,
  At as DocumentSymbolAdapter,
  Mt as FoldingRangeAdapter,
  _t as HoverAdapter,
  Ct as ReferenceAdapter,
  It as RenameAdapter,
