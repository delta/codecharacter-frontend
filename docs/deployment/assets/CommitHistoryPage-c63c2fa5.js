...
import { u as C, T as _ } from './TourProvider-926faeac.js';
import { B as w } from './Button-1591a852.js';
import { B as k } from './ButtonGroup-aa055f2f.js';
import { p as N } from './index-06bcf729.js';
import { a as I } from './ThemeProvider-a8cd1696.js';
import { T as V, i as S } from './react-code-blocks.esm-257a1905.js';
import { C as O } from './Container-27f3d7ab.js';
import { R as M } from './Row-e326ec9f.js';
import { C as B } from './Col-465cf901.js';
...
var T = { __esModule: !0, default: void 0 },
  j = A(e),
  x = A(N),
  L = A(I);
function A(e) {
...
D.propTypes = {
  children: x.default.oneOfType([
    x.default.arrayOf(x.default.node),
    x.default.node,
  ]).isRequired,
  className: x.default.string,
  animate: x.default.bool,
  layout: x.default.oneOf([
    '1-column-left',
    '1-column',
    '2-columns',
    '1-column-right',
  ]),
  lineColor: x.default.string,
};
var P = D;
T.default = P;
var R = {};
  ...
  return Object.keys(e)
    ...
    .map(function (t) {
      return (
        ...
        ('root' === t
          ? (n = e.root)
            ? (F.has(n) || (($ += 1), F.set(n, $.toString())), F.get(n))
            : '0'
          : e[t])
      );
      var n;
...
function W(e, t, n, i) {
  if (
    (void 0 === n && (n = {}),
    void 0 === i && (i = J),
    void 0 === window.IntersectionObserver && void 0 !== i)
  ) {
  ...
  return (
    ...
    function () {
      c.splice(c.indexOf(t), 1),
        ...
        0 === s.size && (l.disconnect(), z.delete(r));
    }
  );
}
var G = [
...
var Y = (function (t) {
    ...
    return (
      ...
      (n.handleChange = function (e, t) {
        e && n.props.triggerOnce && n.unobserve(),
          X(n.props) || n.setState({ inView: e, entry: t }),
  ...
  return (
    ...
    (a.render = function () {
      ...
      return e.createElement(r || 'div', H({ ref: this.handleNode }, l), a);
    }),
    o
  );
})(e.Component);
        ...
        useInView: function (t) {
          var n = void 0 === t ? {} : t,
            ...
            g = e.useCallback(
              ...
              [Array.isArray(i) ? i.toString() : i, l, r, s, c, a, m, o],
            );
          e.useEffect(function () {
            u.current || !f.entry || s || c || h({ inView: !!d });
          });
          var v = [g, f.inView, f.entry];
...
const ie = ({
  ...
  style: p = null,
  textClassName: f = '',
  intersectionObserverProps: h = {
    rootMargin: '0px 0px -40px 0px',
    triggerOnce: !0,
  },
  visible: g = !1,
}) =>
  Q.default.createElement(te.InView, h, ({ inView: h, ref: v }) =>
    Q.default.createElement(
      'div',
      {
        ref: v,
        id: m,
        className: (0, ee.default)(t, 'vertical-timeline-element', {
      ...
      Q.default.createElement(
        ...
        Q.default.createElement(
          'span',
          {
            style: d,
            onClick: s,
            className: (0, ee.default)(l, 'vertical-timeline-element-icon', {
              'bounce-in': h || g,
              'is-hidden': !(h || g),
            }),
          },
        ...
        Q.default.createElement(
          'div',
          {
            style: i,
            onClick: c,
            className: (0, ee.default)(f, 'vertical-timeline-element-content', {
              'bounce-in': h || g,
              'is-hidden': !(h || g),
            }),
          },
          ...
          Q.default.createElement(
            'span',
            { className: (0, ee.default)(a, 'vertical-timeline-element-date') },
            o,
          ),
        ),
      ),
...
ie.propTypes = {
  children: Z.default.oneOfType([
    Z.default.arrayOf(Z.default.node),
    Z.default.node,
  ]),
  className: Z.default.string,
  contentArrowStyle: Z.default.shape({}),
  contentStyle: Z.default.shape({}),
  date: Z.default.node,
  dateClassName: Z.default.string,
  icon: Z.default.element,
  iconClassName: Z.default.string,
  iconStyle: Z.default.shape({}),
  iconOnClick: Z.default.func,
  onTimelineElementClick: Z.default.func,
  id: Z.default.string,
  position: Z.default.string,
  style: Z.default.shape({}),
  textClassName: Z.default.string,
  visible: Z.default.bool,
  intersectionObserverProps: Z.default.shape({
    root: Z.default.object,
    rootMargin: Z.default.string,
    threshold: Z.default.number,
    triggerOnce: Z.default.bool,
  }),
};
var oe = ie;
R.default = oe;
var ae = { VerticalTimeline: T.default, VerticalTimelineElement: R.default };
function re(t) {
  const i = { background: '#1E3821', color: '#fff' },
    [o, a] = e.useState('0');
  return n(ae.VerticalTimeline, {
        ...
        ? t.commitHistoryDetails.map(e => {
            return n(
              ae.VerticalTimelineElement,
              {
                ...
                date:
                  ((r = e.createdAt.toString()),
                  `${r.substring(8, 10)}-${r.substring(5, 7)}-${r.substring(
                    0,
                    4,
                  )}`),
                iconStyle:
                  o == e.id ? i : { background: '#444444', color: '#444444' },
                onTimelineElementClick: () => {
                  a(e.id), t.commitID(e.id);
                },
                children: n('h6', {
...
function ce() {
  ...
  e.useEffect(() => {
    setTimeout(() => {
      q.getCurrentUser().then(e => {
        !1 === e.isTutorialComplete && 4 == e.tutorialLevel && W(!0);
      });
    }, 200);
    new d(s)
      .getCodeRevisions()
      ...
      .catch(e => {
        e instanceof m && u.error(e.message);
      }),
      J.getMapRevisions()
        .then(e => {
          E(!0), V(e);
  ...
  return p(O, {
    fluid: !0,
    className: le.historyMain,
    children: [
      n('div', {
        className: le.buttonContainer,
        children: n('div', {
          className: le.codeMapButton,
          children: p(k, {
            id: 'CommitSelector',
            children: [
              n(w, {
                className: 'Map' == t ? le.whiteButton : le.darkButton,
                onClick: () => {
                  b('Map');
                },
              ...
              n(w, {
                variant: 'outline-light',
                className: 'Code' == t ? le.whiteButton : le.darkButton,
                onClick: () => {
                  b('Code');
                },
                children: 'CODE',
      ...
      p(M, {
        ...
        children: [
              ...
              children:
                (T && 'Code' == t) || (S && 'Map' == t)
                  ? n(re, {
                      commitID: e => {
                        R({ map: P.map, mapImg: '' }),
                          ...
                          I.forEach(t => {
                            ...
                            t.id == e &&
                              (U(t.message),
                              z.some(t => t.CommitId == e)
                                ? R({
                                    map: JSON.parse(t.map),
                                    mapImg:
                                      null ==
                                      (n = z.find(t => t.CommitId === e))
                                        ? void 0
                                        : n.Image,
                                  })
                                : J.getMapByCommitID(t.id)
                                    .then(n => {
                                      R({
                                        map: JSON.parse(t.map),
                                        mapImg: n.mapImage,
                      ...
                      commitHistoryDetails: 'Code' === t ? _ : I,
                      SelectedButton: t,
                    })
                  : n('h1', {
                      className: le.noCommitDataHeader,
                      children: 'Loading...',
                    }),
            }),
          }),
          p(B, {
            lg: '9',
            className: le.codeView,
            id: 'viewBox',
            children: [
              n('div', {
                className: 'Code' == t ? le.codeBox : le.mapBox,
                children:
                  'Code' == t
                    ? n(se, { code: x, codeLang: A })
                    : '' != P.mapImg
                    ? n('img', { className: le.mapImg, src: P.mapImg })
                    : n('div', {
                        className: le.mapLoad,
                  ...
                  onClick: () => {
                    if ('Code' == t && '' != x) {
                      switch (
                        ($(
                          h({
                            currentUserLanguage: 'cpp' === A ? 'c_cpp' : A,
                            currentUserCode: x,
                          }),
                        ),
                        $(g('cpp' === A ? 'c_cpp' : A)),
                      ...
                      v.success(` Loaded commit - ${H}`),
                        F('/dashboard', { replace: !0 });
                    } else
                      'Map' == t &&
                        '' != P.mapImg &&
                        0 !== P.map.length &&
