import { u as a, c as e } from './ThemeProvider-a8cd1696.js';
import { r as t, c as n } from './index-624895d1.js';
const r = ['as', 'disabled'];
function s({
  tagName: a,
  disabled: e,
  ...
  a || (a = null != t || null != n || null != r ? 'a' : 'button');
  const d = { tagName: a };
  ...
  const u = n => {
    (e ||
      ...
      n.preventDefault(),
      e ? n.stopPropagation() : null == i || i(n);
  };
  return (
    'a' === a && (t || (t = '#'), e && (t = void 0)),
    [
  ...
  let { as: t, disabled: i } = a,
    o = (function (a, e) {
      ...
      for (n = 0; n < s.length; n++)
        (t = s[n]), e.indexOf(t) >= 0 || (r[t] = a[t]);
      return r;
    })(a, r);
  const [l, { tagName: d }] = s(Object.assign({ tagName: t, disabled: i }, o));
  return n(d, Object.assign({}, o, l, { ref: e }));
});
i.displayName = 'Button';
const o = t.forwardRef(
  (
    { as: t, bsPrefix: r, variant: i, size: o, active: l, className: d, ...u },
    c,
  ) => {
    const f = a(r, 'btn'),
