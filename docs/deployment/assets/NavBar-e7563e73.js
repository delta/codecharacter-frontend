...
import { D as E, a as M } from './Dropdown-e4232a0e.js';
import { B as P } from './ButtonGroup-aa055f2f.js';
import { M as R } from './Modal-e0d29421.js';
import { B as D } from './Button-1591a852.js';
    ...
    return t(R, {
      ...
      children: [
        t(R.Header, {
          className: me,
          children: [
            s(R.Title, { className: de, children: 'Daily Challenge' }),
            s('button', {
              type: 'button',
        ...
        s(R.Body, { children: "Woohoo, you've completed today's challenge!" }),
        t(R.Footer, {
          children: [
            s(D, {
  ...
  ve = () => {
    ...
    return t('div', {
      ...
      children: [
        ...
        s(ue, { show: E, handleClose: () => M(!1), handleTake: P }),
        t('div', {
