...
import { M as _ } from './Modal-e0d29421.js';
import { C as h } from './Container-27f3d7ab.js';
import { R as p } from './Row-e326ec9f.js';
import { C as v } from './Col-465cf901.js';
import { F as u } from './FormGroup-c1cd9298.js';
...
const N = '_settingFormGroup_2az02_1',
  ...
  H = '_settingLabel_2az02_86',
  S = '_settingDropdown_2az02_94',
  k = '_optionsDropdown_2az02_110',
  B = '_content_2az02_113',
  F = () => {
    const F = e(a),
      I = e(s),
      D = e(t),
              ...
              children: [
                n(v, {
                  ...
                  children: r(u, {
                    controlId: 'fontSize',
                    children: [
                      n('div', { className: H, children: 'Font Size' }),
                      n('select', {
                        className: S,
                        value: I,
                        onChange: e => {
                        ...
                        children: E.map(e =>
                          n(
                            'option',
                            { value: e, className: k, children: e },
                            e,
                          ),
                        ),
                      }),
                ...
                n(v, {
                  ...
                  children: r(u, {
                    ...
                    children: [
                      n('div', { className: H, children: 'Editor Theme' }),
                      n('select', {
                        className: S,
                        value: D,
                        onChange: e => {
