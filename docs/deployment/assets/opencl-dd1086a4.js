import { aT as E } from './index-624895d1.js';
import { r as _ } from './c-6c432317.js';
import { r as e } from './cpp-504b2738.js';
function I(E, _) {
  for (var e = 0; e < _.length; e++) {
    ...
    if ('string' != typeof I && !Array.isArray(I))
      for (const _ in I)
        if ('default' !== _ && !(_ in E)) {
          const e = Object.getOwnPropertyDescriptor(I, _);
          e &&
            Object.defineProperty(
              E,
              _,
              e.get ? e : { enumerable: !0, get: () => I[_] },
            );
        }
  }
...
var O = (function () {
  ...
  return (R = O), (O.displayName = 'opencl'), (O.aliases = []), R;
})();
const T = I({ __proto__: null, default: E(O) }, [O]);
export { T as o };
