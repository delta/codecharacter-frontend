...
import { R as u } from './index.esm-b98454bb.js';
import { F as d, h } from './index.es-9a30e53f.js';
import { O as _ } from './OtherDetails-3f54b891.js';
    ...
    children: [
      ...
      n('div', {
        ...
        children: [
          ...
          l(_, { formNumber: 3, handleAvatarChange: x, isSignUp: !1 }),
          l('div', {
            children: n('button', {
              type: 'button',
              onClick: () => {
              ...
              children: [
                ...
                l(d, { className: p.buttonIcon, icon: h }),
              ],
            }),
          }),
        ],
